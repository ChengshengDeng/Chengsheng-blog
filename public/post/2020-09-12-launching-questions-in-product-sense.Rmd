...
Launch Implementation (Pre + During + Post): With the basic design set, you now need to actually describe how you would implement this design. Break down your approach into three phases: pre-launch tasks, launch tasks, and post-launch tasks. Launching is not just a day-of process.  
...
User Types / Components: If there are multiple types of users (e.g., drivers and riders), we may launch to these users separately: at different times and in different ways.  
...
Risks: What are the risks of the product, and how can you mitigate them? Are there legal challenges? Do you worry about a backlash from customers about privacy changes?  
...
You have built a superior water bottle: it keeps drinks hot and cool, it’s sturdy, and it never spills. How would you launch this 
